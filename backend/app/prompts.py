...
3. FORMATTING:
   - Use Markdown headers (###) to organize key sections.
   - Use bullet points for lists to improve readability.
   - Use bold text for important terms.
4. REFERENCES: Include a footer section titled "### References" at the end. Cite the specific [Excerpt #] used for each part of your answer.
